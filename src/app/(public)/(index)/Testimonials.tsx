    ...
    return (
        <MaxWidthWrapper className=" flex flex-col items-center gap-16 sm:gap-32">
            <div className="flex flex-col lg:flex-row items-center gap-4 sm:gap-6">
                <h1 className=" order-1 mt-2 tracking-tight text-center text-balance !leading-tight font-bold text-5xl md:6xl text-gray-900">What our <span className="relative px-2">Customers</span> say</h1>
            </div> 
            <Stars />
            {
                testimonialDummys.map(testimonialDummy => <TestimonialCard key={testimonialDummy.name } {...testimonialDummy } />)  
            }
